...
- Level 0: [3, 8]<br>
- Level 1:[11] (3+8)[5] (8-3)[-5] (3-8)[24] (3*8)[2.66] (8/3)[0.375] (3/8)<br>
1.1.3 避免重复搜索：<br>
...
计算公式：$$V(s) = \begin{cases} 1.0 & \text{if } \exists x \in s, |x - 24| < \epsilon \\ 0.5 & \text{if } \text{intermediate state} \\ 0.0 & \text{if } \text{no way to 24 or list empty} \end{cases}$$<br>
