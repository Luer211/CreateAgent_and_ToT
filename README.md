...
1.1.2 搜索树前2层结构（以 [3, 8] 为例）：Level 0: [3, 8]Level 1:[11] (3+8)[5] (8-3)[-5] (3-8)[24] (3*8)[2.66] (8/3)[0.375] (3/8)<br>
1.1.3 避免重复搜索：<br>
...
计算公式：$$V(s) = \begin{cases} 1.0 & \text{if } \exists x \in s, |x-24| < \epsilon \\ \max(\text{is_attainable}(x, \text{target}=24)) & \text{else} \end{cases}$$注：在简化版实现中，通常使用启发式判断：剩余数字越少且越接近因子，分值越高。<br>
